...
from UI.supervisor_dashboard import SupervisorDashboardWindow
from UI.gestion_agricultores import GestionAgricultoresWindow  # pestaña de gestión de usuarios/agricultores
# 👉 NUEVO: pestaña de gestión de actividades (aprobar/rechazar + PDF)
from UI.gestion_actividades import GestionActividadesWindow
