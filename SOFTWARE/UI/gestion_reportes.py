...
from DATA.database import obtener_reportes_agricultor, actualizar_estado_reporte
from UI.vista_reporte import VistaReporteWindow
from INFRA.exportador import generar_pdf_reporte_detallado  # Regenerar PDF con estado/comentario/imagen
